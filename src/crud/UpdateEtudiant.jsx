  ...
  const { data: etudiant, isLoading } = useQuery(
    ...
    () => getEtudiantById(id),
    {
      onSuccess: (_) => {
        ...
        setValue("cni", _.cni);
        setValue("nce", _.nce);
        setValue("sexe", _.sexe);
        setValue("dateDeNaissance", _.dateDeNaissance);
        setValue("lieuDeNaissance", _.lieuDeNaissance);
        setValue("adresse", _.adresse);
        setValue("telephone", _.telephone);
